...
class GpsGuiLogger(tk.Tk, Node):
    ...
    def odom_callback(self, msg: Odometry):
        ...
        """
        _, _, self.last_heading = euler_from_quaternion(msg.pose.pose.orientation)
        self.updateTextBox()
...
def main(args=None):
    ...
    default_yaml_file_path = os.path.expanduser("/home/lidc/Desktop/ugv_ws/src/ugv_description/config/irl/gps/irl_wps.yaml")
    if len(sys.argv) > 1:
