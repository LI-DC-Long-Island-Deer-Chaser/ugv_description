...
def generate_launch_description():
        ...
        parameters=[
            {
                ...
                "frame_id": "ugv/base_footprint/gpu_lidar",  # Match your URDF sensor frame
                "inverted": False,
    ...
    # ========== 7. Static TF for IMU sensor ==========
    # Publish static TF from imu_link to IMU sensor frame
    imu_static_tf = Node(
        package="tf2_ros",
        ...
        arguments=[
            ...
            "0",
            "imu_link",
            "ugv/base_footprint/imu_sensor",
        ],
    )

    # ========== 8. Static TF for Lidar sensor ==========
    ...
    lidar_static_tf = Node(
        ...
        arguments=[
            ...
            "0",
            "360lidar_link",
            "ugv/base_footprint/gpu_lidar",
        ],
    )

    # ========== 9. Joint State Publisher ==========
    ...
    return LaunchDescription(
        [
            ...
            imu_static_tf,  # Static TF for IMU
            lidar_static_tf,  # Static TF for Lidar
